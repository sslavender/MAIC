...
def main():
    ...
    parser.add_argument(
        '-opt', type=str, required=False, help='Path to options JSON file.',default="code/options/train/train_MAIC_CelebA.json")
        ...
        for _, batch in enumerate(train_loader):
            ...
            if solver.step % opt['solver']['val_freq'] == 0:
                ...
                for k, v in val_loss_dict.items():
                    a = sum(v) / len(v)
                    solver_log['records']['val_' + k].append(a)
                ...
                a =solver_log['records']['val_loss_total'][-1],
                print(
